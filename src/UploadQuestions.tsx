...
const UploadQuestions: React.FC = () => {
  ...
  const uploadQuestionsToFirestore = async () => {
    setUploading(true);
    setMessage("");
    ...
    try {
      ...
      setMessage("All questions uploaded successfully!");
    } catch (error) {
      console.error("Error uploading questions:", error);
      setMessage("Error uploading questions. Check console.");
    }
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "600px", margin: "2rem auto", fontFamily: "Segoe UI, sans-serif" }}>
      <h2>Upload Quiz Questions to Firestore</h2>
      <button
        onClick={uploadQuestionsToFirestore}
        disabled={uploading}
        style={{
          padding: "0.75rem 1.5rem",
          fontSize: "1rem",
          cursor: "pointer",
          backgroundColor: uploading ? "#ccc" : "#30307d",
          color: "#fff",
          border: "none",
          borderRadius: "0.4rem",
        }}
